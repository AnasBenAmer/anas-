                ...
                <div class="p-6 text-gray-900 ">
                    <form action="{{ route('ads.update', $ad->id) }}" method="POST">
                        ...
                        <div class="flex flex-col">
                            <div class="mb-4">
                                <label class="font-bold text-gray-800" for="titlead">Title Ad</label>
                                <input
                                    class="border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                                    id="titlead" name="title" type="text" placeholder=" update the ad title "
                                    value="{{ $ad->title }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    placeholder="update the ad description" value="{{ $ad->description }}">
                            </div>
                            <div class="mb-4">
