            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 text-center">
                    ...
                    <div class=" mt-3  ">
                        ...
                        <form action="{{ route('ads.store') }}" action="post">
                            @csrf
                            <select id="email" class="!inline mt-1 w-1/4  rounded-md  " name="building_ad"
                    ...
                    <div class="  ">
                        <div class="">
                            <div class="my-6">
                                ...
                                <div><select id="email" class="!inline mt-1 w-1/4  rounded-md   " name="title"
                                        :value="" required>
                                </div>
                    ...
                    <div class=" ">
                        ...
                        <div>
                            <textarea id="title" name="description" cols="12"class="w-1/2 rounded-md	" rows="10"
